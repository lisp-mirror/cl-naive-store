(ignore-errors (delete-package :test-speed-naive-documents))

(require :sb-sprof)

(defpackage :test-speed-naive-documents
...
(in-package :test-speed-naive-documents)
...
(defmethod get-store-class ((test-name (eql :test-speed-naive-documents)))
  'document-store)

(defmethod cl-naive-tests:setup-suite ((test-name (eql :test-speed-naive-documents)))
...
(cl-naive-tests:define-suite (:test-speed-naive-documents)
...
(defmethod cl-naive-tests:tear-down-suite ((test-name
                                            (eql :test-speed-naive-documents)))
  (setf *do-partial-indexing* t)
  (setf *collection* nil)
  (setf *store* nil))
