(in-package :cl-naive-store.document-type-defs)

#|
cl-naive-store.document-type-defs is a "declaritive" implementation (I am using the word loosly) of cl-naive-document-type (abstract data type???).
