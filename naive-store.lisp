#|
The short and the sweet is that this is a naive but cleverish hierarchical
persisted in memory data store.
  ...
  (time
   (with-open-file (in filename :if-does-not-exist :create)
	 ...
	 (loop for line = (read in nil)
	    while line
	    ;;TODO: Add check for already loaded and do index
